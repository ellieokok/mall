                    ...
                    <div class="row">
                        <div class="col-xs-12 no-padding-right">
                            <div style="width: 260px; float: left;">
                                <img src="/wemall-multiUser/Theme/<?php echo ($settheme); ?>/thumb.png" style="width: 240px; height: 340px;"
                                     class="img-thumbnail">
                    ...
                    <div class="row">
                        <div class="col-xs-12" style="margin-top:20px;">
                            <?php if(is_array($theme)): $i = 0; $__LIST__ = $theme;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$theme): $mod = ($i % 2 );++$i;?><div style="width: 260px; float: left;">
                                    <img src="/wemall-multiUser/Theme/<?php echo ($theme); ?>/thumb.png"
                                         style="width: 240px; height: 340px;"
                                         class="img-thumbnail">
                                    <a href="<?php echo U('Home/Config/tplSet',array('theme'=>$theme));?>" type="button"
