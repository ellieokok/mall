            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Home/Weixin/addWxMenu');?>" class="btn btn-danger ">
                                新增菜单
                            </a>
                        </div>
                        <!-- /.btn-group -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($wxMenu)): $i = 0; $__LIST__ = $wxMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="table-action"><a
                                            href="<?php echo U('Home/Weixin/modWxMenu',array('id'=>$menu['id']));?>">修改</a><a
                                            href="<?php echo U('Home/Weixin/delWxMenu',array('id'=>$menu['id']));?>">删除</a></td>
                    ...
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger"
                                    onclick="batchUrl('<?php echo U('Home/Weixin/delWxMenu');?>')">全部删除
                            </button>
                        </div>
                    </div>
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a class="btn btn-danger" href="<?php echo U('Home/Wechat/createWxMenu');?>">生成自定义菜单</a>
                        </div>
                    </div>
                </div>
            </div>
