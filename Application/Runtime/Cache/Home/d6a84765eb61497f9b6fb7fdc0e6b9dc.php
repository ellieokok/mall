        ...
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">新增省份</h3>
                </div>
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo U('Home/Config/addProvince');?>" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="name" placeholder="" value="<?php echo ($province["name"]); ?>"
                                       type="text">
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    if ('<?php echo ($province); ?>') {
        $('input[name="id"]').val('<?php echo ($province["id"]); ?>');
    }
</script>