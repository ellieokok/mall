            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Home/User/addAuthGroup');?>" class="btn btn-danger ">
                                新增用户组
                            </a>
                        </div>
                        <!-- /.btn-group -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($authGroupList)): $i = 0; $__LIST__ = $authGroupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="table-action">
                                        <?php if(($group["id"]) > "1"): ?><a href="<?php echo U('Home/User/modAuthGroup',array('id'=>$group['id']));?>">修改</a><a
                                                href="<?php echo U('Home/User/delAuthGroup',array('id'=>$group['id']));?>">删除</a><?php endif; ?>
                                    </td>
