...
<head>
    ...
    <script src="/Public/Admin/dist/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" href="/Public/Admin/toastr/toastr.min.css">

    <!-- jQuery 2.1.4 -->
    <script src="/Public/Admin/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <script>
        var URL = '/';
        var UEURL = '/Public/Admin/UEditor/';
        var PUBLICURL = '/Public';
        var UPLOADSURL = '/Public/Uploads/';
    </script>
    <!--ueditor-->
    ...
    <script type="text/javascript" charset="utf-8" src='/Public/Admin/nprogress/nprogress.js'></script>
    <link rel='stylesheet' href='/Public/Admin/nprogress/nprogress.css'/>

    <link rel='stylesheet' href='/Public/Home/dist/css/lrtk.css'/>
    <!--<script type="text/javascript" charset="utf-8" src='/Public/Home/dist/js/lrtk.js'></script>-->
    <link rel="stylesheet" href="/Public/Admin/bootstrap/css/piAdmin.css">
</head>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/Public/Admin/dist/img/avatar-wemall.png" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo (session('homeName')); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/Public/Admin/dist/img/avatar-wemall.png" class="img-circle"
                                     alt="User Image">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Home/Shop/addShop');?>" class="btn btn-danger ">
                                新增店铺
                            </a>
                        </div>
                        <!-- /.btn-group -->
                    ...
                    <div class="table-responsive" style="overflow-x: visible;">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($shopList)): $i = 0; $__LIST__ = $shopList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="table-action"><a target="_parent"
                                                                href="<?php echo U('Home/Shop/switchShop',array('id'=>$shop['id']));?>">选择</a><a
                                            href="<?php echo U('Home/Shop/delShop',array('id'=>$shop['id']));?>">删除</a></td>
...
<div id="loading" style="top: 150px;">
    <div class="lbk"></div>
    <div class="lcont"><img src="/Public/Admin/dist/img/loading.gif" alt="loading...">正在加载...</div>
</div>
...
<!-- daterangepicker -->
<script src="/Public/Admin/dist/js/moment.min.js"></script>
...
<!-- AdminLTE App -->
<script src="/Public/Admin/dist/js/app.min.js?v=1"></script>
<!--layer-->
<script src="/Public/Admin/layer/layer.js"></script>
<!--toastr-->
<script src="/Public/Admin/toastr/toastr.min.js"></script>
<!--bootbox-->
<script src="/Public/Admin/bootbox/bootbox.js"></script>
<!--pjax-->
<script src="/Public/Admin/pjax/jquery.pjax.js"></script>
<!--jquery.form-->
<script src="/Public/Admin/form/jquery.form.js"></script>
<script src="/Public/Admin/dist/js/template.js"></script>
<script src="/Public/Home/dist/js/wemall.js?v=2"></script>
