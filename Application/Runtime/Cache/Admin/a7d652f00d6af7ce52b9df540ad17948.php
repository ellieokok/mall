    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo U('Admin/Artical/addArtical');?>" method="post">
                    <div class="box-body">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new img-thumbnail">
                                        <?php if(empty($artical["file_id"])): ?><img
                                            ...
                                            <?php else: ?>
                                            <img src="/multi/Public/Uploads/<?php echo ($artical["savepath"]); echo ($artical["savename"]); ?>"><?php endif; ?>
