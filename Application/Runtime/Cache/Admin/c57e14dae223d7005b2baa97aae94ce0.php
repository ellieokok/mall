    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo U('Admin/Shop/addAds');?>" method="post">
                    <div class="box-body">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new img-thumbnail">
                                        <?php if(empty($ads["file_id"])): ?><img
                                            ...
                                            <?php else: ?>
                                            <img src="/multi/Public/Uploads/<?php echo ($ads["savepath"]); echo ($ads["savename"]); ?>"><?php endif; ?>
                                        <input class="form-control" name="file_id" id="file_id" placeholder=""
                                               value="<?php echo ($ads['file_id']?$ads['file_id']:0); ?>"
                                               type="hidden">
