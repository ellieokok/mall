    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo U('Admin/Config/wxTplMsgSet');?>" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">订单发货提醒</label>

                            <div class="col-sm-2">
                                <input class="form-control" disabled placeholder="" value="OPENTM207763419"
                                       type="text">
                            </div>

                            <div class="col-sm-8">
                                <input class="form-control" placeholder="" name="OPENTM207763419"
                                       value="<?php echo ($OPENTM207763419); ?>"
                                       type="text">
                            </div>
                        </div>
                    </div>
