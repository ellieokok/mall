    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <!-- form start -->
                <form action="<?php echo U('Admin/Shop/addProduct');?>" method="post" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="name" placeholder="" value="<?php echo ($product["name"]); ?>"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <label class="radio-inline"><input name="sku" type="radio"
                                    <?php if($product["sku"] == 1): ?>checked="checked"<?php endif; ?>
                                    value="1"><span>开启</span></label>
                                <label class="radio-inline"><input name="sku" type="radio"
                                    <?php if($product["sku"] == 0): ?>checked="checked"<?php endif; ?>
