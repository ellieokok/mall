            ...
            <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        <div class="btn-group">
                            <a href="<?php echo U('Admin/Shop/addLabel');?>" class="btn btn-danger ">
                                新增标签
                            </a>
                        </div>
                        <!-- /.btn-group -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($label)): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$label): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="table-action"><a
                                            href="<?php echo U('Admin/Shop/modLabel',array('id'=>$label['id']));?>">修改</a><a
                                            href="<?php echo U('Admin/Shop/delLabel',array('id'=>$label['id']));?>">删除</a>
                                    </td>
                            ...
                            <div class="mailbox-controls">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger "
                                            onclick="batchUrl('<?php echo U('Admin/Shop/delLabel');?>')">全部删除
                                    </button>
                                </div>
                            </div>
                        </div>
