...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="<?php echo U('Admin/User/shop');?>"><i class="fa "></i>商户管理</a></li>
            ...
            <div class="box box-default">
                ...
                <form class="form-horizontal" action="<?php echo U('Admin/Shop/productSearch');?>" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label">商户状态</label>
                                        ...
                                        <div class="btn-group" style="margin: 0px">
                                            ...
                                            <div class="dropdown-menu">
                                                <img style="height: 200px"
                                                     src="/wemall-multiUser/Public/Uploads/<?php echo ($product["savepath"]); echo ($product["savename"]); ?>">
                                            </div>
                                        </div>
                                    </td>
